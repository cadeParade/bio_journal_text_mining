...
def format_display_items(paper_dict):
	...
	print papers_with_relevant_sentences
	
	for paper in papers_with_relevant_sentences:
		sentence_list = []
		for sentence in paper.classified_sentences:
			sentence_w_classification = (sentence.sentence, sentence.overall_classification, sentence.general_classification)
...
def index():
	...
	#displays search results page
		...
		scored_sentences = rank_sentences.rank_sentences(list_of_sentences, query, max_num_sents_to_analyze)
